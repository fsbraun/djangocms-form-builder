    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag_type', djangocms_form_builder.fields.TagTypeField(choices=[('div', 'div'), ('section', 'section'), ('article', 'article'), ('header', 'header'), ('footer', 'footer'), ('aside', 'aside')], default='div', help_text='Select the HTML tag to be used.', max_length=255, verbose_name='Tag type')),
            ],
            options={
                'verbose_name': 'Form',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag_type', djangocms_form_builder.fields.TagTypeField(blank=True, choices=[('div', 'div'), ('section', 'section'), ('article', 'article'), ('header', 'header'), ('footer', 'footer'), ('aside', 'aside')], default='div', help_text='Select the HTML tag to be used.', max_length=255, verbose_name='Tag type')),
