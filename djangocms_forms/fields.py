...
class ButtonGroup(forms.RadioSelect):
    template_name = "djangocms_forms/admin/widgets/button_group.html"
    option_template_name = "djangocms_forms/admin/widgets/button_group_option.html"

    class Media:
        css = {"all": ("djangocms_forms/css/button_group.css",)}


class ColoredButtonGroup(ButtonGroup):
    option_template_name = (
        "djangocms_forms/admin/widgets/button_group_color_option.html"
    )
...
class IconGroup(ButtonGroup):
    option_template_name = "djangocms_forms/admin/widgets/icon_group_option.html"
