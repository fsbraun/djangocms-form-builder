...
from djangocms_forms import settings
...
class FormPlugin(CMSAjaxForm):
    ...
    render_template = f"djangocms_forms/{settings.framework}/form.html"
    change_form_template = "djangocms_forms/admin/forms.html"
    allow_children = True
